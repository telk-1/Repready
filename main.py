...
def claim_referral():
    ...
    try:
        ...
        # ref_code is the referrer's own email, lightly obfuscated on the client.
        # Look up the referrer by matching ref_code back to a stored user.
        r = requests.get(
        ...
        # Prevent double-claiming: check new user isn't already someone's referral
        ...
        # Mark the new user as referred (stored in their own state blob)
        ...
        # Grant the referrer a bonus plan credit inside their own state blob
