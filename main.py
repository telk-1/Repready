...
RAPIDAPI_KEY = os.environ.get('RAPIDAPI_KEY', 'bef624a072msh78f618ba4adea63p1c4fa8jsnbdbc7cc47910')
...
- FIRST PLAN (no lift history provided): NEVER prescribe firm heavy loads. Give conservative starting weights scaled to the user's bodyweight and level, and add to each main lift's notes: "Starting point — adjust so the last 2 reps feel hard (RPE 7-8)". Confidence in exact numbers comes only from real logged history.
